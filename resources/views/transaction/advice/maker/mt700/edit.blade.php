                    ...
                    <div class="col-md-6">
                        <table width='100%' class='table'>
                            <tr style='vertical-align: middle'>
                                ...
                                <td width='50%'>
                                    {{ Form::inputText(null,null, $record->mt700->F20, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    {{ Form::inputText(null,null, $record->mt700->F31C, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputText(null,null, $record->mt700->F31D, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null,  $record->mt700->F50, null, ['rows' => '4', 'readonly'])}}
                            ...
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null,  $record->mt700->F59, null, ['rows' => '4', 'readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null, $record->mt700->F32B, null, ['rows' => '2','readonly'])}}
                                    <input type="hidden" name="transactions_{{ Str::lower($record->source) }}[F32B_AMT]" value="{{ $record->mt700->F32B_AMT }}">
                                    <input type="hidden" name="transactions_{{ Str::lower($record->source) }}[F32B_CUR]" value="{{ $record->mt700->F32B_CUR }}">
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table">
                            <tr style='vertical-align: middle'>
                                ...
                                <td  width='5%' class='text-right'>: </td>
                                <td width='50%'>
                                    {{ Form::inputText(null,null, $record->mt700->F42A, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputText(null,null, $record->mt700->F39A, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputText(null,null, $record->mt700->F42C, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null, $record->mt700->F44A, null, ['rows' => '4', 'readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null, $record->mt700->F52A, null, ['rows' => '4', 'readonly'])}}
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 500px;">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="text-center">{{ $record->source }}</h4>
                        @php
                            echo '<code>';
                            echo '<pre>';
