                    ...
                    <div class="col-md-6">
                        <table width='100%' class='table'>
                            <tr style='vertical-align: middle'>
                                ...
                                <td width='50%'>
                                    {{ Form::inputText(null,null, $record->mt707->F20, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    {{ Form::inputText(null,null, $record->mt707->F31C, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputText(null,null, $record->mt707->F31D, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null,  $record->mt707->F50, null, ['rows' => '4', 'readonly'])}}
                            ...
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null,  $record->mt707->F59, null, ['rows' => '4', 'readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null, $record->mt707->F32B, null, ['rows' => '2','readonly'])}}
                                    <input type="hidden" name="transactions_{{ Str::lower($record->source) }}[F32B_AMT]" value="{{ $record->mt707->F32B_AMT }}">
                                    <input type="hidden" name="transactions_{{ Str::lower($record->source) }}[F32B_CUR]" value="{{ $record->mt707->F32B_CUR }}">
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table">
                            <tr style='vertical-align: middle'>
                                ...
                                <td  width='5%' class='text-right'>: </td>
                                <td width='50%'>
                                    {{ Form::inputText(null,null, $record->mt707->F42A, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputText(null,null, $record->mt707->F39A, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputText(null,null, $record->mt707->F42C, null, ['readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null, $record->mt707->F44A, null, ['rows' => '4', 'readonly'])}}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class='text-right'>: </td>
                                <td>
                                    {{ Form::inputTextarea(null,null, $record->mt707->F52A, null, ['rows' => '4', 'readonly'])}}
                                </td>
                            </tr>
                        </table>
                    </div>
