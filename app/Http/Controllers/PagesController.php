...
class PagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.dashboard', compact('page_title', 'page_description','devices','current_session_id'));
    }
    ...
    {
        $page_title       = 'SVG';
        // $page_breadcrumbs = [['page'  => 'icons/svg','title' =>  'svg'],['page'  => 'icons/svg','title' =>  'svg']];
