...
{
    private $page_title         = "Master Currency";
    private $page_description   = "Currency Management";
    private $permission         = 'currency'; //jamak
    private $route              = 'currencies'; //plural
    ...
    public function index(Request $req)
    {
        if($req->ajax()){
            ...
            return DataTables::of($model)
                ...
                ->addColumn('action', function($data){
                    return ButtonSED($data, 'currencies', 'currency', false);
                })
        ...
        return view('master.currency.index', compact('page_title', 'page_description', 'page_breadcrumbs', 'route'));
    }
    ...
    public function store(Request $request)
    {
        ...
        MasterCurrency::Create($requestData);
    ...
    public function edit($id)
    {
        ...
        return view('master.currency.index', compact('page_title', 'page_description', 'page_breadcrumbs', 'page_buttons', 'route','edit'));
    }
    ...
    {
        $id     = Crypt::decrypt($id);
        $delete = MasterCurrency::findOrFail($id);
        $delete->delete() == true
