...
class CreateTransactionMt707sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_mt707s', function (Blueprint $table) {
            $table->id();
        ...
        Schema::table('transaction_mt707s',  function(Blueprint $table){
    ...
    {
        Schema::dropIfExists('transaction_mt707s');
    }
}
